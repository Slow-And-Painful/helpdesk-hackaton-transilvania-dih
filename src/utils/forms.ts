...
export function validateFieldsValues(
...
export function getFormChangedFields<FormData extends FormValues>(
  initialValues: FormData,
  currentValues: FormData,
): FormValuesChanged<FormData> {
  validateFieldsValues(initialValues, currentValues)

  return Object.keys(initialValues).reduce((obj, key) => {
    obj[key as keyof FormValuesChanged<FormData>] =
